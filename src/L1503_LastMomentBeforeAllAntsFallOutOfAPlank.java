...
public class L1503_LastMomentBeforeAllAntsFallOutOfAPlank {

    /*
    Here the approach is like
    we have to assume as ants are invisible to each other and magical too they can pass each other
    so assuming every ant single on plank takes how much time to pass the whole plank in a direction
    the highest time taken by the ant is the last moment time
     */
